...
"[project]/app/components/TaskForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(TaskForm, "RL+Zbs2TIka0YpcBOJptmHqCgYA=");
_c = TaskForm;
...
"[project]/app/components/TaskItem.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(TaskItem, "PcvudgQ4pB1b8YUmRhNmcS3boU8=");
_c = TaskItem;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$TaskItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/TaskItem.tsx [app-client] (ecmascript)");
"use client";
;
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filters.map((filterOption)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            tasks.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: tasks.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$TaskItem$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        task: task,
                        onToggle: onToggle,
                        onDelete: onDelete
                    }, task.id, false, {
...
"[project]/app/hooks/useTasks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useTasks = ()=>{
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            const formattedTasks = data.map({
                                "useTasks.useEffect.fetchTasks.formattedTasks": (t)=>({
                                        id: String(t.id),
                                        title: t.title,
                                        completed: t.completed,
                                        createdAt: t.created_at
                                    })
                            }["useTasks.useEffect.fetchTasks.formattedTasks"]);
    ...
    const addTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTasks.useCallback[addTask]": async (title)=>{
    ...
    const toggleTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTasks.useCallback[toggleTask]": async (id)=>{
            try {
                const token = localStorage.getItem("token");
                if (!token) return;
                ...
                if (response.ok) {
                    setTasks({
                        "useTasks.useCallback[toggleTask]": (prev)=>prev.map({
                                "useTasks.useCallback[toggleTask]": (task)=>task.id === id ? {
                                        ...task,
    ...
    const deleteTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTasks.useCallback[deleteTask]": async (id)=>{
            try {
                const token = localStorage.getItem("token");
                if (!token) return;
...
"[project]/app/task-manager/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$TaskForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/TaskForm.tsx [app-client] (ecmascript)");
...
_s(TaskManagerPage, "4znC5B49A6I0PKZrX1UJBn5bzDo=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useTasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c = TaskManagerPage;
const __TURBOPACK__default__export__ = TaskManagerPage;
var _c;
__turbopack_context__.k.register(_c, "TaskManagerPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_71c770c6._.js.map